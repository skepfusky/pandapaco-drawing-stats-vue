<template>
  <header id="main-nav">
    <nav>
      ...
      <ul>
        <li>
          <a href="#">Browse</a><span class="nav-line"></span>
          <div class="dropdown">
            <h2>YOS</h2>
            ...
            <div class="dropdown_species">
              <species-card-header sTitle="Baekhyun" sAlt="EXO" />
              <species-card-header sTitle="Xiumin" sAlt="EXO" />
              <species-card-header sTitle="Sehun" sAlt="EXO" />
              <species-card-header sTitle="Kyungsoo" sAlt="EXO" />
              <species-card-header sTitle="Chen" sAlt="EXO" />
              <species-card-header sTitle="Jin" sAlt="BTS"/>
              <species-card-header sTitle="Jimin" sAlt="BTS"/>
              <species-card-header sTitle="Jungkook" sAlt="BTS"/>
              <species-card-header sTitle="Namjoon" sAlt="BTS"/>
              <species-card-header sTitle="Suga" sAlt="BTS"/>
            </div>
          </div>
        </li>
        <li>
...
@mixin dropdown_hover_el($hoverpos: -5px) {
  transform: translateY(0px);
  @include prop_transition();
